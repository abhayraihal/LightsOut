		...
		<div class="row" >
			<div class="col-xs-4 col-xs-offset-8">
				<form action="searchmovies.php" method="get" class="form-inline search-form" role="form">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle navbar-brand" data-toggle="dropdown" role="button" aria-expanded="false"> Sort-By <i class="fa fa-caret-down"></i></a>
							<ul class="dropdown-menu" role="menu">
								...
								<li><a href="Release_Date.php">Release Date</a></li>	
							</ul>
						</li>
