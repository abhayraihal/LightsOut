...
if (!$result) {
	...
	<div class="container wrapper">
		...
		<div class="row">
			<div class="col-xs-6">
				<h2 class="text-center text-success" style="color:white">Your Favorites</h2>
				<?php
				if (isset($items)) {
					...
					foreach ($items_count_value as $id => $qty) {
						...
						$title = "<a class=\"a12\" href='moviedetails.php?id= " . $result_row['movie_id'] . "'>" . $result_row['movie_name'] . "</a>";
			...
			<div class="col-xs-6">
				<h2 class="text-center text-success" style="color:white">Your Reviews</h2>
				<?php
						...
						<div class="panel panel-default">
							<div class="panel-heading movie-list">
								<h3 class="panel-title">
									<a class="a12" href="moviedetails.php?id=<?= $review_row['movie_id'] ?>"><?= $review_row['movie_name'] ?></a>
								</h3>
							</div>
							<div class="panel-body">
								<h4 style="color:white">Rating: <span class="<?php
